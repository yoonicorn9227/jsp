				...
				<div id="mypage">
					...
					<div class="eventList">
						<ul>
							...
							<li>
								<div class="img">
									<a href="event_view.do?bno=${bdto.bno}"><img src="../upload/${bdto.bfile}" alt="진행중 이벤트" /></a>
								</div>
								<div class="txt">
									<div class="subject">${bdto.btitle}</div>
									<div class="day">이벤트 기간 : ${bdto.bdate} ~ 2024-04-29</div>
								</div>
							</li>
							</c:forEach>
							<!-- //반복 -->
