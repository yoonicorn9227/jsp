					...
					<div class="informbox">
						<div class="inform">
							<form name="frm" method="post" action="doLogin.jsp">
								<ul>
									<li><input type="text" name="id" id="l_login" class="loginType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='loginType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
									<li><input type="password" name="pw" id="p_login" class="passType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
								</ul>
							</form>
							<div class="btn"><a href="#" id="s_btn" class="sbtn">로그인</a></div>
